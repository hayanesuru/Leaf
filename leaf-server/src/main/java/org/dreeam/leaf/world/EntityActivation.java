...
public final class EntityActivation {
    ...
    public void activateEntities(ServerLevel world) {
        ...
        int playerSize = 0;
        final Player[] players = world.players().toArray(EMPTY_PLAYERS);
        ...
        boolean dab = DynamicActivationofBrain.enabled;
        boolean dontEnableIfInWater = DynamicActivationofBrain.dontEnableIfInWater;
        int startSq = DynamicActivationofBrain.startDistanceSquared;
        int distMod = DynamicActivationofBrain.activationDistanceMod;
        int maxPrio = DynamicActivationofBrain.maximumActivationPrio;
        for (int i = 0; i < size; i++) {
            ...
            if (dab
                ...
                entity.activatedPriority = distSq > startSq ?
